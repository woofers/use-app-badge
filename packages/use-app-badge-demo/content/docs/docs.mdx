...
<img style={{ objectFit: 'contain' }} className="rounded-lg mt-2 mb-4 mx-auto" width="280px" height="45px" src="/use-app-badge/windows.webp" alt="Badge API on Windows Taskbar" title="Badge API on Windows Taskbar" />
