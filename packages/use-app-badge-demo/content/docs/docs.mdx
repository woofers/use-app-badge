...
<img style={{ objectFit: 'contain' }} className="rounded-lg mt-2 mb-4 mx-auto" width="280px" height="45px" src="https://raw.githubusercontent.com/woofers/use-app-badge/main/screenshots/windows.png" alt="Badge API on Windows Taskbar" title="Badge API on Windows Taskbar" />

## Features

<ul className="feature-list">
<li>TypeScript support</li>
<li>Core bundle size under 1.3kB bytes GZipped</li>
<li><code>setAppBadge</code> and <code>clearAppBadge</code> throw errors if webapp is not installed or running in an insecure context</li>
<li>Safely detect and fallback on unsupported browsers using <code>isAppBadgeSupported</code> method</li>
</ul>

## Installation

<div aria-hidden style={{ height: 4 }}></div>
...
<div aria-hidden style={{ height: 8 }}></div>
...
This API does not offer a way to request permission for Safari.  If you
